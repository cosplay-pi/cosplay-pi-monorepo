...
import { ActiveUserDevicePageContent } from "./components/active-user-device-page-content";
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: `my-devices/:activeUserDeviceId`,
            element: <ActiveUserDevicePageContent />,
          },
        ],
      },
      {
